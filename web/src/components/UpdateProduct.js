              ...
              switch (res.statusId) {
                case 1:
                  ...
                  if (res.value.matchResult.fullMatchProducts) {
                    setFullMatchProducts(
                      res.value.matchResult.fullMatchProducts
                    );
                    updateUserMessages()
                  }
                  if (res.value.matchResult.partMatchProducts) {
                    setPartMatchProducts(
                      res.value.matchResult.partMatchProducts
                    );
                    updateUserMessages()
                  }
                  setTimeout(() => {
                  ...
                  <>
                    ...
                    >
                      <Grid
                        ...
                        style={{ marginTop: 50 }}
                      >
                        <h1>המוצר שלך עודכן בהצלחה במערכת!!!</h1>
